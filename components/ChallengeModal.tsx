      ...
      <div className="bg-quest-card w-full max-w-lg rounded-2xl shadow-2xl border-2 border-quest-accent p-6 flex flex-col relative max-h-[90vh] overflow-y-auto">
        ...
        {submitted ? (
          <div className="animate-fade-in">
            <div
              className={`p-4 rounded-lg mb-4 ${isCorrect ? "bg-green-900/30 border border-green-800" : "bg-red-900/30 border border-red-800"}`}
            >
              <p
                className={`font-bold mb-1 ${isCorrect ? "text-green-400" : "text-red-400"}`}
              >
